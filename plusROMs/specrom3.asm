...
; ---
  ...
  IFDEF plus
    ...
    ENDIF
  ELSE
        DEFB    $FF, $FF        ; Five unused locations.
  ENDIF
        DEFB    $FF, $FF, $FF   ;
...
L0048:  PUSH    BC              ; Save the other main registers.
      ...
      IFDEF plus
        CALL    L386E           ; Routine KEYBOARD executes a stage in the
      ELSE
...
L0C17:  JR      C,L0C22         ; forward to PO-EACH if not a command, '<>' etc.
