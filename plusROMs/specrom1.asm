...
; Formatting message
      ...
      IFDEF spanish
l03a7   defm    "Ya formateado. Tecla A para", $0d
...
l03f6   rst     $28
        ...
        jr      z,l0407
      IFDEF v41
        jp      l045b           ; "Invalid drive" error if not 1
      ELSE
...
l0415   cp      'U'
      IFDEF v41
        jp      nz,l045b        ; if 2nd string not "U", error
      ELSE
...
l07ba   call    l2b64           ; page in normal memory
      ...
      IFDEF spanish
l07c9   defm    "K LIBRES", $0d, 0
l07d1   defm    "NINGUN FICHERO ENCONTRADO", $0d, $0d, 0
      ELSE
...
l0888   pop     af              ; discard return address of scan-loop
        ld      a,(T_ADDR)
        sub     l0f83 and $ff   ; store command code (0=SAVE,1=LOAD,
...
l113a   pop     af              ; drop scan-loop return address
        ld      a,(T_ADDR)
        sub     (l0f8e and $ff)+$28 ; form token code INK to OVER
        rst     $28
...
; Drives present messages
      ...
      IFDEF spanish
l24be   defm    "Unidades disponibles:  ", 0
l24c4   defm    "M", 0
l24c8   defm    "A y M", 0
l24d4   defm    "A, B y M", 0
l24e4   defm    ".", 0
      ELSE
l24be   defm    "Drive", 0
l24c4   defm    " M:", 0
...
; The +3 BASIC and +3DOS error messages
      IFDEF spanish
l276d   defm    "Error en MERG", 'E'+$80
l2778   defm    "FICHERO INCORRECT", 'O'+$80
l2787   defm    "Error en COD", 'E'+$80
l2791   defm    "EXCESO DE PARENTESI", 'S'+$80
l27a2   defm    "YA EXISTE EL FICHER", 'O'+$80
l27b5   defm    "NOMBRE NO VALID", 'O'+$80
l27c1   defm    "NO EXISTE ESE FICHER", 'O'+$80
l27d4   defm    "DIPOSITIVO NO VALID", 'O'+$80
l27e2   defm    "VELOCIDAD NO VALID", 'A'+$80
l27f3   defm    "NOTA NO VALID", 'A'+$80
l2804   defm    "NUMERO MUY GRAND", 'E'+$80
l2812   defm    "NOTA FUERA DE MARGE", 'N'+$80
l2823   defm    "FUERA DE MARGE", 'N'+$80
l282f   defm    "DEMASIADAS NOTA", 'S'+$80
l2842   defm    "NOMBRE INCORRECT", 'O'+$80
l284e   defm    "PARAMETRO INCORRECT", 'O'+$80
l285c   defm    "UNIDAD NO ENCONTRAD", 'A'+$80
l286b   defm    "FICHERO NO ENCONTRAD", 'O'+$80
l2879   defm    "YA EXISTE EL FICHER", 'O'+$80
l288c   defm    "FIN DE FICHER", 'O'+$80
l289d   defm    "DISCO LLEN", 'O'+$80
l28a6   defm    "DIRECTORIO LLEN", 'O'+$80
l28b4   defm    "FICHERO SOLO LECTUR", 'A'+$80
l28c5   defm    "FICHERO NO ABIERT", 'O'+$80
l28d2   defm    "FICHERO YA EN US", 'O'+$80
l28e5   defm    "SINTAXIS INCORRECT", 'A'+$80
l28fd   defm    "FALTA SECCIO", 'N'+$80
l290b   defm    "FALTA CACH", 'E'+$80
l2913   defm    "FICH. DEMASIADO GRAND", 'E'+$80
l291f   defm    "DISCO NO DE ARRANQU", 'E'+$80
l2933   defm    "UNIDAD YA EN US", 'O'+$80
l293f   defm    "UNIDAD NO PREPARAD", 'A'+$80
l294e   defm    "DISCO PROTEGID", 'O'+$80
l2965   defm    "FALLO DE BUSQUED", 'A'+$80
l296e   defm    "ERROR DE DATO", 'S'+$80
l297c   defm    "SIN DATO", 'S'+$80
l2983   defm    "SIN MARCA DIRECCIONE", 'S'+$80
l2997   defm    "FORMATO NO RECONOCID", 'O'+$80
l29af   defm    "ERROR DESCONOCID", 'O'+$80
l29c1   defm    "DISCO CAMBIAD", 'O'+$80
l29d6   defm    "SOPORTE NO ADECUAD", 'O'+$80
l29e6   defm    "ATRIBUTO NO VALID", 'O'+$80
l29f7   defm    "COPIA DE/HACIA CINT", 'A'+$80
l2a0f   defm    "DESTINO POLIVALENT", 'E'+$80
l2a29   defm    "DESTINO NO ES UNIDA", 'D'+$80
l2a42   defm    "UNIDAD B AUSENT", 'E'+$80
l2a59   defm    "+2A NO ADMITE FORMA", 'T'+$80
l2a74   defm    "LA UNIDAD NO ES A NI ", 'B'+$80
l2a8a   defm    "UNIDAD INCORRECT", 'A'+$80
l2a97   defm    "ERROR DE LONGITU", 'D'+$80
      ELSE
...
; in page 0 (bug: this should be page 7!)
      IFDEF v41
l2ecd   ld      bc,$0007        ; file 0, page 0 (oops, should be page 7!)
      ELSE
...
; Files copied messages
      ...
      IFDEF spanish
l3291   defm    $0d, "  1 fichero copiado.", $0d, $0d, 0
l32a5   defm    " ficheros copiados.", $0d, $0d, 0
      ELSE
