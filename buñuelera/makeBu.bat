...
echo  org     $fe80           >  deforg.asm
echo  output  dzx7b_rcs_0.bin >> deforg.asm
\emuscriptoria\sjasmplus dzx7b_rcs.asm
echo  org     $fc20           >  deforg.asm
echo  output  dzx7b_rcs_1.bin >> deforg.asm
\emuscriptoria\sjasmplus dzx7b_rcs.asm
