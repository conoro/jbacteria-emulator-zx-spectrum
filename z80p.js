...
cp('a', 'a', 4),          // CP A
'if(f&64)st+=5;else st+=11,pc=m[sp>>14][sp&16383]|m[sp+1>>14&3][sp+1&16383]<<8,sp=sp+2&65535',// RET NZ
pop('b', 'c'),            // POP BC
jpc('f&64'),              // JP NZ
...
cp('a', 'a', 4),          // CP A
'if(f&64)st+=5;else st+=11,pc=m[sp>>14][sp&16383]|m[sp+1>>14&3][sp+1&16383]<<8,sp=sp+2&65535',
pop('b', 'c'),            // POP BC
jpc('f&64'),              // JP NZ
...
inr('a'),                 // IN A,(C)
outr('a'),                // OUT (C,A
'st+=11;f=(l|h<<8)+sp+(f&1);t=h>>3&17|sp>>10&34|f>>9&68;h=f>>8&255;l=f&255;f=f>>16|ova[t>>4]|h&168|hca[t&7]|(l|h?0:64)',
