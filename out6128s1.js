      ...
      if(gm==0)
        for(z= 0; z<=cr[9]; z++)
          for(y= 0, ma= cr[13]|cr[12]<<8; y<cr[6]; y++)
            for(x= 0, pos= (y*cr[9]+y+z)*(cr[1]<<gm+2); x<cr[1]; x++)
              eld3[pos++]= pl[lut0[by= mw[ma>>12][t=ma<<1&0x7ff|z<<11]]],
              eld3[pos++]= pl[lut1[by]],
              eld3[pos++]= pl[lut0[by= mw[ma++>>12][t+1]]],
              eld3[pos++]= pl[lut1[by]];
      else if(gm==1)
        for(z= 0; z<=cr[9]; z++)
          for(y= 0, ma= cr[13]|cr[12]<<8; y<cr[6]; y++)
        ...
        for(var z= 0; z<=cr[9]; z++)
          for(var y= 0, ma= cr[13]|cr[12]<<8; y<cr[6]; y++)
            for(var x= 0, pos= (y*cr[9]+y+z)*(cr[1]<<gm+2); x<cr[1]<<1; x++){
